...
from nanobot.agent.memory import MemoryConsolidator, MemoryEvent
...
class AgentLoop:
    ...
    async def _process_message(
        ...
        if msg.channel == "system":
            ...
            await self.emit_memory_event(
                session,
                channel,
                chat_id,
                len(all_msgs[1 + len(history) :]),
            )
